    ...
    <LayoutDashboard>
      <div className="space-y-8">
        <section className="rounded-3xl border bg-gradient-to-br from-card via-card to-primary/10 p-6 shadow-sm sm:p-8">
          ...
          <h1 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl">NexTask ITSM/helpdesk</h1>
          <p className="mt-3 max-w-3xl text-muted-foreground">
            Base visual profesional preparada para tickets, usuarios, RAG, reportes, PostgreSQL, APIs y futuras integraciones.
            No contiene lógica de negocio compleja todavía.
          </p>
        </section>
        ...
        <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {tarjetas.map((tarjeta) => {
            ...
            return (
              <Tarjeta key={tarjeta.titulo} className="transition-colors hover:border-primary/40">
                ...
                <TarjetaDescripcion className="mt-2">{tarjeta.descripcion}</TarjetaDescripcion>
              </Tarjeta>
            );
          })}
        </section>
        ...
        <section className="grid gap-4 lg:grid-cols-[1.5fr_1fr]">
          <Tarjeta>
            ...
            <TarjetaDescripcion className="mt-2">
              Este espacio queda reservado para widgets reales, tablas, gráficas y actividad reciente cuando el equipo agregue módulos.
            </TarjetaDescripcion>
            <div className="mt-6 rounded-2xl border border-dashed bg-background/60 p-10 text-center text-sm text-muted-foreground">
              Placeholder del dashboard enterprise. Aquí se conectarán datos reales más adelante.
            </div>
          </Tarjeta>
          ...
          <Tarjeta>
            ...
            <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
              ...
              <li>• Redis y WebSockets</li>
              <li>• RAG, embeddings y búsqueda inteligente</li>
              <li>• APIs internas y microservicios futuros</li>
            </ul>
          </Tarjeta>
        </section>
      </div>
